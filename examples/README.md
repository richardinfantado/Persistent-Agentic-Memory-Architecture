...
Additional example object types (`tool_invocation`, `tool_result`, `working_memory`, Delegation Object, Evaluation Snapshot) live in [`../test-vectors/valid/`](../test-vectors/valid/) since they double as positive test vectors.
