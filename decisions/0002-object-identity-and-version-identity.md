# Decision: Object identity and version identity
...
Separate stable object identity from immutable version identity so replay, export, and conflict detection do not depend on storage internals.
