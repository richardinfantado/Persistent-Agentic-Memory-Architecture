# Decision: Embedding Space identity
...
Require every vector and semantic result to identify an Embedding Space and reject direct comparison across incompatible spaces.
