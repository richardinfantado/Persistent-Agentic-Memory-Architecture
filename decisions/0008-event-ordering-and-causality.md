# Decision: Event ordering and causality
...
Require per-object event ordering and logical atomicity between state changes and required ledger entries without prescribing a physical log.
