# Decision: Canonical Memory Object envelope
...
Define a transport-neutral envelope with required identity, scope, content, state, actor, provenance, and time fields while leaving storage layout unresolved.
