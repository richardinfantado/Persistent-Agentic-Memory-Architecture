# Decision: Deletion, redaction, and tombstone behavior
...
Permit content removal with scope-safe tombstones where policy allows, while tracking derived-index deletion independently.
